...
[![Stable release](https://img.shields.io/badge/version-0.4.0-green.svg)](https://github.com/Netis/packet-agent/releases/tag/0.4.0)
...
```bash
wget https://github.com/Netis/packet-agent/releases/download/v0.4.0/netis-packet-agent-0.4.0.el6.x86_64.rpm
rpm -ivh netis-packet-agent-0.4.0.el6.x86_64.rpm
```
...
```bash
wget https://github.com/Netis/packet-agent/releases/download/v0.4.0/netis-packet-agent-0.4.0_amd64.deb
sudo dpkg -i netis-packet-agent-0.4.0_amd64.deb
```
