...
3. 拷贝待安装的 packet-agent rpm/deb 到 ansible_pktg.yaml 同一目录下。如果待安装的 rpm/deb 不是 yaml 中指定的 netis-packet-agent-0.3.2.el6.x86_64.rpm / netis-packet-agent-0.3.2_amd64.deb，则将 ansible_pktg.yaml rpm_file/deb_file 修改为你需要的文件名。</br>
